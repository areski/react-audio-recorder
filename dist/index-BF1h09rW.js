...
function Ne() {
  return he || (he = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function s() {
      if (L === 0) {
        ce = console.log, le = console.info, ue = console.warn, fe = console.error, de = console.group, ge = console.groupCollapsed, ve = console.groupEnd;
        var e = {
          configurable: !0,
          enumerable: !0,
          value: A,
...
` + g[i].replace(
    ...
    function N(e, r, t, n, d, i) {
      if (typeof e == "string" || typeof e == "function" || e === p || e === T || e === V || e === Z || e === D || e === Se || typeof e == "object" && e !== null && (e.$$typeof === re || e.$$typeof === ee || e.$$typeof === b || e.$$typeof === $ || e.$$typeof === H || e.$$typeof === Ce || e.getModuleId !== void 0)) {
        ...
        o = "", (e === void 0 || typeof e == "object" && e !== null && Object.keys(e).length === 0) && (o += " You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports."), e === null ? n = "null" : te(e) ? n = "array" : e !== void 0 && e.$$typeof === v ? (n = "<" + (l(e.type) || "Unknown") + " />", o = " Did you accidentally export a JSX literal instead of a component?") : n = typeof e, console.error(
...
var w = Oe();
const Pe = (l, x, E) => {
  const [A, s] = B(!1), [u, f] = B(!1), [R, a] = B(0), [c, P] = B(), [C, h] = B(), [m, N] = B(), S = J(() => {
    const v = setInterval(() => {
      a((_) => _ + 1);
    }, 1e3);
    h(v);
    ...
    C == null && navigator.mediaDevices.getUserMedia({ audio: l ?? !0 }).then((v) => {
      s(!0);
    ...
    u ? (f(!1), c == null || c.resume(), S()) : (f(!0), y(), c == null || c.pause());
  }, [c, f, S, y]);
  return {
    startRecording: Y,
    stopRecording: W,
  ...
  const { LiveAudioVisualizer: l } = await import("./react-audio-visualize.es-DZPD0CO2.js");
  return { default: l };
}), Ie = ({
  ...
  Pe(
    ...
    const V = crossOriginIsolated ? await v(p) : p, T = crossOriginIsolated ? u : "webm", $ = URL.createObjectURL(V), b = document.createElement("a");
    b.style.display = "none", b.href = $, b.download = `audio.${T}`, document.body.appendChild(b), b.click(), b.remove();
  };
  return ke(() => {
    (Y || E) && h != null && l != null && (l(h), s && _(h));
  }, [h]), /* @__PURE__ */ w.jsxs(
    "div",
    {
